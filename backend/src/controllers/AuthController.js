...
const accessTokenSecret = process.env.ACCESS_TOKEN_SECRET || "access-token-secret-cong-ty-cysai-ma-secret-token-@@@@@";
// Thời gian sống của refreshToken
const refreshTokenLife = process.env.REFRESH_TOKEN_LIFE || "3650d";
// Mã secretKey này phải được bảo mật tuyệt đối, các bạn có thể lưu vào biến môi trường hoặc file
const refreshTokenSecret = process.env.REFRESH_TOKEN_SECRET || "refresh-token-secret-cong-ty-cysai-ma-refresh-secret-token-@@@@@";
/**
 * controller login
 * @param {*} req 
 * @param {*} res 
